                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Your Datasets</h4>
                                        <div class="mb-2">
                                            <div class="row row-cols-sm-auto g-2 align-items-center">
                                                <div class="col-12">
                                                    <a href="upload-dataset.php" class="btn btn-sm btn-success"><i class="mdi mdi-plus-circle me-2"></i> Upload Dataset</a>
                                                </div>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <a href="edit-dataset.php" class="action-icon"><button type="button" class="btn w-sm btn-success waves-effect waves-light mb-1">Update</button></a>
                                                            <a href="edit-dataset.php" class="action-icon"><button type="button" class="btn w-sm btn-danger waves-effect waves-light">Delete</button></a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>Card title</td>
